...
#SPARK_MASTER_IP=192.168.42.24
SPARK_MASTER_HOST=192.168.42.24
#SPARK_LOCAL_IP=192.168.42.24
SPARK_WORKER_MEMORY=12g
SPARK_WORKER_CORES=8
SPARK_HOME=/usr/local/spark-2.2.0
SPARK_DIST_CLASSPATH=$(/usr/local/hadoop-2.6.5/bin/hadoop classpath)
SPARK_LOCAL_DIRS=/data2/SparkData
SPARK_PID_DIR=/usr/local/spark-2.2.0/pids
